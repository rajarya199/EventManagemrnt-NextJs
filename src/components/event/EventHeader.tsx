...
const EventHeader = ({eventId}:EventProps) => {
  ...
  return (
    <div>
        <div className='mb-4'>
        <header className="w-full rounded-lg shadow-md bg-white dark:bg-primary-600 border-b">
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4 dark:text-gray-300 text-gray-600">
                            ...
                            {eventInfo.type==="Physical" && (   <div className='flex flex-col'>
                                ...
                                {showFullAddress && (
                                    <div className="mt-2 ml-6 text-sm dark:text-gray-300 text-gray-500 max-w-xl">
                                        {fullAddress}
                                    </div>
                                )}
                            </div>
