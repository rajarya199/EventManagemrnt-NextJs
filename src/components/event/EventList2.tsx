...
export const EventList2 = ({ eventData }:eventProps) => {
  return (
        ...
        >
          ...
          <div className="p-6">
            <div className="flex gap-2 mb-3">
              ...
              <span
                className={`px-3 py-1 rounded-full text-sm font-medium ${data.event?.type === "Virtual" ? "bg-violet-100 text-violet-800" : "bg-teal-100 text-teal-800"}`}
              >
                {data.event?.type}
              </span>
            </div>
            ...
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <div className="flex items-center gap-2">
                ...
                {/* <span>
                  {format(data.event?.startTime, "MMM d, yyyy")} -{" "}
                  {format(data.event?.endTime, "MMM d, yyyy")}
                </span> */}
              </div>
              <div className="flex items-center gap-2">
